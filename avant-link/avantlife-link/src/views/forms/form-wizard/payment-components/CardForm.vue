  ...
  <div class="card-form">
    ...
    <div class="card-form__inner">
      <div class="card-input">
        <label for="cardNumber" class="card-input__label">Número de tarjeta{{ /*cardForm.cardNumber*/ }}</label>
        <input
          type="tel"
      ...
      <div class="card-input">
        <label for="cardName" class="card-input__label">Nombre en tarjeta{{ /*formData.cardName*/ }}</label>
        <input
          type="text"
          :id="fields.cardName"
          v-letter-only
      ...
      <div class="card-form__row">
        <div class="card-form__col">
          <div class="card-form__group">
            <label for="cardMonth" class="card-input__label">Fecha de Expiración{{ /*cardForm.expirationDate*/ }}</label>
            <select
        ...
        <div class="card-form__col -cvv">
          <div class="card-input">
            <label for="cardCvv" class="card-input__label">CVV{{ /*cardForm.CVV*/ }}</label>
            <input
              type="tel"
              class="card-input__input"
              v-number-only
...
<style lang="scss">
  @import 'src/assets/scss/paymentStyles.scss';
</style>
